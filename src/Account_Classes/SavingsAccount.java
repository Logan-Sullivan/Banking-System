...
public class SavingsAccount extends Account{
    ...
    //constructor for constructing from csv
    public SavingsAccount(String accountNumber ,double intrestRate, String compoundFreq, boolean overdraftBackup,double balance){
    ...
    public String toString() {
        return this.accountNumber+","+this.intrestRate+","+this.compoundFreq+","+(this.overdraftBackup ? 1:0+","+this.getBalance());
    }
}